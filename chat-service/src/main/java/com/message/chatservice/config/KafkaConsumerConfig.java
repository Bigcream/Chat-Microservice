...
public class KafkaConsumerConfig {
    ...
    public DefaultErrorHandler errorHandler() {
        BackOff fixedBackOff = new FixedBackOff(2000, 2);
        DefaultErrorHandler errorHandler = new DefaultErrorHandler((consumerRecord, exception) -> {
            System.out.println(String.format("consumed record %s because this exception was thrown",consumerRecord.toString(),exception.getClass().getName()));
        }, fixedBackOff);
        return errorHandler;
    }
