...
import { IConversation } from "@src/interface/chat/conversation.interface";

const chatStore = useChatStore();
const conversations: Ref<IConversation> = computed(() => chatStore.activeConversation)
...
//   chatStore.getConversationById(1)
