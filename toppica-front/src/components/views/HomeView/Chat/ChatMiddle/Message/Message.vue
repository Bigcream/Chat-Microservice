...
// Reply message
const replyMessage = computed(() =>  getMessageById(activeConversation.value, props.message.replyTo))
</script>
    ...
    <div class="xs:mb-6 md:mb-5 flex" :class="{ 'justify-end': props.self }">
      ...
      <div class="flex items-end">
        ...
        <div
          ...
          class="group max-w-[31.25rem] p-5 rounded-b transition duration-500 break-all"
          :class="{
